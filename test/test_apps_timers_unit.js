	...
	let tests = [
		{
			...
			timems: 0, // 00:00:00
			expected: 1546329600000 // "Tue Jan 01 2019 00:00:00 GMT-0800 (Pacific Standard Time)"
		},
		{
			date: Date.parse("1 Jan 2019 12:34:56"),
			timems: 43200000, // 12:00:00
			expected: 1546372800000 // "Tue Jan 01 2019 12:00:00 GMT-0800 (Pacific Standard Time)"
		},
		{
			date: Date.parse("1 Jan 2019"),
			timems: 45296000, // 12:34:56
			expected: 1546374896000 // "Tue Jan 01 2019 12:34:56 GMT-0800 (Pacific Standard Time)"
		},
		{
			date: Date.parse("1 Jan 2019"),
...
function testTimer_getEarliest() {
	...
	let tests = [
		...
		},
		{
			...
			expected: 1546405200000 // "Tue Jan 01 2019 21:00:00 GMT-0800 (Pacific Standard Time)"
		},
		{
			base: Date.parse("1 Jan 2019 12:00:00"),
