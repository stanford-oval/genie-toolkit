...
var TEST_CASES = [
    ...
    [{"trigger":{"args":[{"name":{"id":"tt:param.value"},"type":"Measure","value":{"unit":"F","value":70.0},"operator":">"}],"person":"thermostat","name":{"id":"tt:thermostat.temperature"}}},
    'notify when  the temperature on @thermostat\'s thermostat changes and value is greater than 70 F'],
    [{"rule":{"action":{"args":[],"name":{"id":"tt:builtin.notify"}},"trigger":{"args":[{"name":{"id":"tt:param.time"},"type":"Time","value":{"month":-1,"hour":8,"year":-1,"day":-1,"minute":30,"second":0.0},"operator":"is"}],"name":{"id":"tt:builtin.at"}}}},
    'send me a message ____ when every day and time is 08:30'],
