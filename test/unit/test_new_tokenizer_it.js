...
const TEST_CASES = [
    ...
    ['almeno 25gb', 'almeno 25 gb', 'almeno NUMBER_0 gb', { NUMBER_0: 25 }],
    ['almeno -3gb', 'almeno -3 gb', 'almeno -3 gb', {}],
    ['almeno -25gb', 'almeno -25 gb', 'almeno NUMBER_0 gb', { NUMBER_0: -25 }],
    ['almeno 1,75 gb', 'almeno 1,75 gb', 'almeno NUMBER_0 gb', { NUMBER_0: 1.75 }],
    ['almeno 1,75, e poi di più', 'almeno 1,75 , e poi di piu\u0300', 'almeno NUMBER_0 , e poi di piu\u0300', { NUMBER_0: 1.75 }],
    ['almeno 25, e poi di più', 'almeno 25 , e poi di piu\u0300', 'almeno NUMBER_0 , e poi di piu\u0300', { NUMBER_0: 25 }],
    ['almeno 25.000 e poi di più', 'almeno 25000 e poi di piu\u0300', 'almeno NUMBER_0 e poi di piu\u0300', { NUMBER_0: 25000 }],
    ['almeno 25.00 e poi di più', 'almeno 2500 e poi di piu\u0300', 'almeno NUMBER_0 e poi di piu\u0300', { NUMBER_0: 2500 }],
    ...
    ['almeno tredici', 'almeno 13', 'almeno NUMBER_0', { NUMBER_0: 13 }],
    ['almeno venti', 'almeno 20', 'almeno NUMBER_0', { NUMBER_0: 20 }],
    ['almeno ventuno', 'almeno 21', 'almeno NUMBER_0', { NUMBER_0: 21 }],
    ['almeno ventidue', 'almeno 22', 'almeno NUMBER_0', { NUMBER_0: 22 }],
    ['almeno ventinove', 'almeno 29', 'almeno NUMBER_0', { NUMBER_0: 29 }],
    ['almeno novantuno', 'almeno 91', 'almeno NUMBER_0', { NUMBER_0: 91 }],
    ['almeno novantadue', 'almeno 92', 'almeno NUMBER_0', { NUMBER_0: 92 }],
    ['almeno un milione', 'almeno 1000000', 'almeno NUMBER_0', { NUMBER_0: 1e6 }],
    ['almeno due milioni', 'almeno 2000000', 'almeno NUMBER_0', { NUMBER_0: 2e6 }],
    ['almeno un milione duemilatre', 'almeno 1002003', 'almeno NUMBER_0', { NUMBER_0: 1002003 }],
    ['almeno un milione duecentomila e tre', 'almeno 1200003', 'almeno NUMBER_0', { NUMBER_0: 1200003 }],
    ['almeno un milione duecentomilatre', 'almeno 1200003', 'almeno NUMBER_0', { NUMBER_0: 1200003 }],
    ['almeno 1,75 miliardi', 'almeno 1750000000', 'almeno NUMBER_0', { NUMBER_0: 1.75e9 }],
    ['almeno cento', 'almeno 100', 'almeno NUMBER_0', { NUMBER_0: 100 }],
    ['almeno mille', 'almeno 1000', 'almeno NUMBER_0', { NUMBER_0: 1000 }],
    ['almeno duemiladuecento', 'almeno 2200', 'almeno NUMBER_0', { NUMBER_0: 2200 }],
    ['almeno duemilatrecentoquarantacinque', 'almeno 2345', 'almeno NUMBER_0', { NUMBER_0: 2345 }],
    ['almeno trecentomila', 'almeno 300000', 'almeno NUMBER_0', { NUMBER_0: 300000 }],
    ['almeno trecentoquindicimila', 'almeno 315000', 'almeno NUMBER_0', { NUMBER_0: 315000 }],

    // ordinals
    ['voglio il 1º', 'voglio il 1 o', 'voglio il 1 o', {}],
    ['voglio la 1ª', 'voglio la 1 a', 'voglio la 1 a', {}],
    ['voglio il 13º', 'voglio il 13 o', 'voglio il NUMBER_0 o', { NUMBER_0: 13 }],
    ['voglio il 21º', 'voglio il 21 o', 'voglio il NUMBER_0 o', { NUMBER_0: 21 }],
    ...
    ['voglio il tredicesimo', 'voglio il 13', 'voglio il NUMBER_0', { NUMBER_0: 13 }],
    ['voglio il ventesimo', 'voglio il 20', 'voglio il NUMBER_0', { NUMBER_0: 20 }],
    ['voglio il ventunesimo', 'voglio il 21', 'voglio il NUMBER_0', { NUMBER_0: 21 }],
    ['voglio il ventiduesimo', 'voglio il 22', 'voglio il NUMBER_0', { NUMBER_0: 22 }],
    ['voglio il ventinovesimo', 'voglio il 29', 'voglio il NUMBER_0', { NUMBER_0: 29 }],
    ['voglio il novantunesimo', 'voglio il 91', 'voglio il NUMBER_0', { NUMBER_0: 91 }],
    ['voglio il milionesimo', 'voglio il 1000000', 'voglio il NUMBER_0', { NUMBER_0: 1e6 }],
    ['voglio il un milione duemilatreesimo', 'voglio il 1002003', 'voglio il NUMBER_0', { NUMBER_0: 1002003 }],
    ['voglio il duemilionesimo', 'voglio il 2000000', 'voglio il NUMBER_0', { NUMBER_0: 2e6 }],
    ['voglio il duemiliardesimo', 'voglio il 2000000000', 'voglio il NUMBER_0', { NUMBER_0: 2e9 }],
    ['voglio il centesimo', 'voglio il 100', 'voglio il NUMBER_0', { NUMBER_0: 100 }],
    ['voglio il millesimo', 'voglio il 1000', 'voglio il NUMBER_0', { NUMBER_0: 1000 }],
    ['voglio il duemiladuecentesimo', 'voglio il 2200', 'voglio il NUMBER_0', { NUMBER_0: 2200 }],
    ['voglio il duemilatrecentoquarantacinquesimo', 'voglio il 2345', 'voglio il NUMBER_0', { NUMBER_0: 2345 }],
    ['voglio il trecentomillesimo', 'voglio il 300000', 'voglio il NUMBER_0', { NUMBER_0: 300000 }],
    ['voglio il trecentoquindicimillesimo', 'voglio il 315000', 'voglio il NUMBER_0', { NUMBER_0: 315000 }],
    ['voglio il trecentoquindicimiladuesimo', 'voglio il 315002', 'voglio il NUMBER_0', { NUMBER_0: 315002 }],
    ...
    ['05/18/2020', '5 / 18 / 2020', '5 / NUMBER_0 / NUMBER_1', { NUMBER_0: 18, NUMBER_1: 2020 }],
    ['05/32/2020', '5 / 32 / 2020', '5 / NUMBER_0 / NUMBER_1', { NUMBER_0: 32, NUMBER_1: 2020 }],
    ['32/05/2020', '32 / 5 / 2020', 'NUMBER_0 / 5 / NUMBER_1', { NUMBER_0: 32, NUMBER_1: 2020 }],
