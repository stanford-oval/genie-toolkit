...
const SQLDatabase = require('./syncsqldb');
...
module.exports = new lang.Class({
    ...
    _init: function(platform, tablename, fields, tierManager) {
        this._platform = platform;
        this._tierManager = tierManager;

        this._sqldb = new SQLDatabase(platform.getSqliteDB(), tablename, fields);
