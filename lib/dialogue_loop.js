...
const FORCE_NEW_STYLE_DIALOGUE = true;
...
async function computePrediction(dlg, policy, state, intent) {
    ...
    if (FORCE_NEW_STYLE_DIALOGUE && intent.isProgram) {
...
async function handleUserInput(dlg, state, input) {
    ...
    if (!input.intent.isDialogueState && (!FORCE_NEW_STYLE_DIALOGUE || !input.intent.isProgram)) {
