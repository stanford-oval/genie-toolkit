...
module.exports = class QueryDialog extends Dialog {
    constructor() {
        super();
    ...
    execute() {
        Q.try(() => {
            ...
            var name = 'Query ' + this.capitalizeSelector(this.kind, this.channel);
    ...
    handle(command) {
        ...
        if (this.kind === null) {
            ...
            this.manager.schemas.getMeta(this.kind, 'queries', this.channel).then((schema) => {
                this.schema = schema;
                this._continue();
            }).catch((e) => {
                this.fail(e.message);
