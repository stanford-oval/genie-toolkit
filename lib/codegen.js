...
function describeTrigger(dlg, kind, channel, schema, args) {
...
function describeAction(dlg, kind, channel, schema, args) {
    ...
    if (confirm && (confirm.indexOf('$') >= 0 || args.length === 0)) {
        ...
        return describeTrigger(dlg, kind, channel, schema, args);
    }
}
