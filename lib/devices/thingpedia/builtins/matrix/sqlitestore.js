...
module.exports = class SqliteStore extends MatrixInMemoryStore {
    ...
    startup() {
        if (this.startedUp) {
            console.log(`SqliteStore.startup: already started`);
            return Promise.resolve();
        }

        console.log(`SqliteStore.startup: connecting to backend`);
        return this._connect().then(() => {
            console.log(`SqliteStore.startup: loading presence events`);
            return this._getUserPresenceEvents();
        }).then((userPresenceEvents) => {
            console.log(`SqliteStore.startup: processing presence events`);
    ...
    _connect() {
        return Promise.all([
            ...
            console.log(`SqliteStore: loaded initial data`);
     ...
     */
    _loadSyncData() {
        console.log(`SqliteStore: loaded sync data`);
        return this._db.withClient((dbClient) => {
