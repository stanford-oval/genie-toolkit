...
module.exports = class ChannelFactory {
    ...
    getChannel(device, name, mode, params) {
        return Q.try(function() {
            ...
            switch (mode) {
            case 'r':
                factory = device.getTriggerClass(name);
                break;
            case 'q':
                factory = device.getQueryClass(name);
                break;
            case 'w':
                factory = device.getActionClass(name);
                break;
            default:
            ...
            var state = new ChannelStateBinder(this._engine.platform);
            if (hasState)
