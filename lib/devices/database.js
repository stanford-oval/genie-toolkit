...
module.exports = class DeviceDatabase extends ObjectSet.Base {
    ...
    getForeignDevice(principal, kind) {
        var id = 'org.thingpedia.builtin.thingengine.remote-' + principal + '-' + kind;
        if (this._devices.has(id))
            return Q(this._devices.get(id));

        return this.loadOneDevice({ kind: 'org.thingpedia.builtin.thingengine.remote', principal: principal, remoteKind: kind }, true);
    }
