...
module.exports = class StateMachineDialog extends Dialog {
    ...
    start() {
        this._firstIntent = new Promise((callback, errback) => {
        ...
        this._dlg._ = this._;
        this._dlg.ngettext = this.ngettext;
        return Promise.resolve(this._fn(this._dlg, intent, ...this._args)).then(() => {
            if (!this._cancelled)
