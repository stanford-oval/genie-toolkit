...
module.exports = class SemanticAnalyzer {
    constructor(obj) {
        ...
        if ('special' in this.root) {
            ...
            this.learn = this.root.$$fallback.learn;
        } else {
    ...
    static makeFallbacks(raw, fallbacks, learnFromFallback) {
        return new SemanticAnalyzer({ $$fallback: { raw: raw, fallbacks: fallbacks, learn: learnFromFallback }});
    }
