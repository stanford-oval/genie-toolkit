...
module.exports = class MakeDialog extends Dialog {
            ...
            if (this.expecting === ValueCategory.Command) {
                ...
                if (command.isPrimitive || command.isEmpty) {
                    ...
                    if (!command.isEmpty) {
                        ...
                        command.primitive.root = command.root;
                        this[command.primitiveType] = command.primitive;
    ...
    _getSchema(obj, what) {
        if (obj === null || obj.isEmpty)
            return Q();
        return this.manager.schemas.getMeta(obj.selector.kind, what, obj.channel).then((schema) => {
            obj.schema = schema;
        });
    }
