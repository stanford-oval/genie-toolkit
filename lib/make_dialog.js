            ...
            if (this.expecting === ValueCategory.Command) {
                ...
                if (command.isFilter) {
                    ...
                    if (filter.value === null) {
                        ...
                        switch (filter.type) {
                            case 'String': return this.ask(ValueCategory.RawString, "What's the value of this filter?");
                            case 'Number': return this.ask(ValueCategory.Number, "What's the value of this filter?");
                        }
                    }
                    var idx = this.choices.indexOf(this._commandClass);
                    this.filters[idx].push(filter);
