        ...
        return this.handleGeneric(command).then((handled) => {
            ...
            if (this.expecting === ValueCategory.Command) {
                if (command.isHelp) {
                    ...
                    console.log("Make rule debug: ", this, this.count);
                    ...
                    // take next command
                    var expect;
                    if (command.isTrigger) expect = ['query', 'action'];
                    else if (command.isQuery) expect = ['trigger', 'action'];
                    else if (command.isAction) expect = ['trigger', 'query'];
            ...
            if (command.name === 'rule') {
                return this._handleMakeRule(['trigger', 'query', 'action']);
            }
