...
module.exports = class InitializationDialog extends Dialog {
    ...
    _continue() {
        ...
        this.reply("If you don't know what to say, try 'list commands'.");
        this.reply("If you need help at any point, try 'help'.");
        this.reply("You'll want to start by setting up your devices and accounts though.");
        this.reply("To do so, try 'configure' followed by the type of device or account (e.g., 'configure twitter' or 'configure tv'), or try 'discover' and I'll take a look at what you have.");
