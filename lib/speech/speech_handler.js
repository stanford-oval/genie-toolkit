...
module.exports = class SpeechHandler extends events.EventEmitter {
    constructor(conversation, platform, options = {}) {
        ...
        this._conversation.on('inactive', () => {
            console.log('Conversation is now inactive, stopping auto-trigger');
    ...
    _startVoiceInput() {
        ...
        if (this._wakeWordDetector) {
            this._wakeWordDetector.on('sound', () => {
                // ignore sound while we're speaking
