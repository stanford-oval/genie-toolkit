...
module.exports = class SentenceSampler extends Stream.Transform {
    constructor(constants, options) {
        ...
        this._detokenizer = i18n.get(options.locale).detokenizer;
    ...
    _transform(input, encoding, callback) {
        const { id, preprocessed, target_code } = input;
        const processor = new SentenceProcessor(this._constants, this._detokenizer, this._options, id, preprocessed, target_code);
