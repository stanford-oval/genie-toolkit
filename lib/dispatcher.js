    ...
    _handleGeneric(command) {
        ...
        if (this.expecting !== null &&
            ...
            if (this.expecting === ValueCategory.Predicate &&
                (command.isPredicate || command.isFilter || command.isBack))
                return false;
            if (this.expecting === ValueCategory.PermissionResponse &&
                (command.isPredicate || command.isFilter || command.isPermissionRule || command.isYes || command.isMaybe || command.isBack))
                return false;
