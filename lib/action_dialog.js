...
module.exports = class ActionDialog extends Dialog {
    ...
    execute() {
        ...
        var args = this.args.map(ThingTalk.Ast.valueToJS);
        ...
        if (this.args === null) {
            ...
            if (this.subdialog === null) {
                ...
                var slots = this.schema.schema.map(function(typeString, i) {
                    ...
                    return { name: this.schema.args[i], type: type,
                             question: this.schema.questions[i] };
                });

                this.push(new SlotFillingDialog(slots, this.originalCommand.args, true));
