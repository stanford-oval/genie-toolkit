...
module.exports = class ContactSearchDialog extends Dialog {
    constructor(contact, type) {
        ...
        case 'tt:phone_number':
            this.category = ValueCategory.PhoneNumber;
            break;
        case 'tt:email_address':
            this.category = ValueCategory.EmailAddress;
            break;
        case 'tt:contact':
    ...
    static resolve(parent, type, slot) {
        ...
        if (parent.subdialog === null) {
            var contact = slot.value.value;
            parent.push(new ContactSearchDialog(contact, type));
