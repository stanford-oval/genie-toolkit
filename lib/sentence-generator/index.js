...
module.exports = class SentenceGenerator extends stream.Readable {
    ...
    async _initialize() {
        const [say, get_gps, get_time] = await Promise.all([
            this._schemas.getMeta('org.thingpedia.builtin.thingengine.builtin', 'action', 'say'),
            this._schemas.getMeta('org.thingpedia.builtin.thingengine.phone', 'query', 'get_gps'),
            this._schemas.getMeta('org.thingpedia.builtin.thingengine.builtin', 'query', 'get_time')
        ]);
