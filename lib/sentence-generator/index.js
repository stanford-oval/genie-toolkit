...
module.exports = class SentenceGenerator extends stream.Readable {
    ...
    async _initialize() {
        ...
        (await importGenie(path.resolve(__dirname, '../../languages/thingpedia.genie')))($options, this._grammar);
        ...
        const abspath = path.resolve(__dirname, '../../languages/' + this._options.language + '/' + (this._options.targetLanguage || 'thingtalk') + '.genie');
