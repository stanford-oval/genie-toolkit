...
module.exports = class SentenceGenerator extends stream.Readable {
    ...
    async _initialize() {
        ...
        (await importGenie(path.resolve(__dirname, '../../languages/thingpedia.yasgg')))($options, this._grammar);
        ...
        const abspath = path.resolve(__dirname, '../../languages/' + this._options.language + '/' + (this._options.targetLanguage || 'thingtalk') + '.yasgg');
        const languageClass = await importGenie(abspath);
