...
class MinibatchDialogueGenerator {
    ...
    async init() {
        this._partialDialogs = [new PartialDialogue()];
        this._partialDialogs.length = 1;
        this._numTotalPartialDialogs = 1;
    }
