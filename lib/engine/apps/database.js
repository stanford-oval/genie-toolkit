...
class AppDatabase extends events.EventEmitter {
    ...
    async createApp(program, options = {}) {
        ...
        const app = new AppExecutor(this._engine, program.prettyprint(), options, name, description);
...
AppDatabase.prototype.$rpcMethods = ['loadOneApp', 'createApp', 'removeApp', 'getAllApps', 'getApp', 'hasApp'];
