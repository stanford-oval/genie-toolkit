 ...
 * @package
 */
class ExecWrapper extends ExecEnvironment {
    constructor(engine, app) {
        ...
        // by default, output to the app itself (which will broadcast on all conversations)
        // when running interactively, this will be overridden to output to a specific
        // StatementExecutor
        this.output = app;
    ...
    reportError(message, error) {
        ...
        return this.output.notifyError(error);
    }

    output(outputType, outputValues) {
        return this.output.output(outputType, outputValues);
    }
}
