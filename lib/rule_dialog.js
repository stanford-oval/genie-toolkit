...
module.exports = class RuleDialog extends Dialog {
    ...
    describe() {
        ...
        if (this.action) {
            actionDesc = Codegen.describeAction(this, this.action.kind,
                                                this.action.channel,
                                                this.action.schema,
        ...
        if (this.query) {
            queryDesc = Codegen.describeAction(this, this.query.kind,
                                               this.query.channel,
                                               this.query.schema,
        ...
        if (this.trigger) {
            triggerDesc = Codegen.describeTrigger(this, this.trigger.kind,
        ...
        return Q.try(() => {
            ...
            if (this.action && this.query && this.trigger) {
                name = Codegen.capitalizeSelector(this.trigger.kind, this.trigger.channel) + ' to ' +
                    Codegen.capitalizeSelector(this.query.kind, this.query.channel) + ' to ' +
                ...
                name = Codegen.capitalizeSelector(this.query.kind, this.query.channel) + ' to ' +
                    Codegen.capitalizeSelector(this.action.kind, this.action.channel);
            }
