...
module.exports = class RuleDialog extends Dialog {
    ...
    _computeIcon() {
        for (let i = this._primitiveList.length-1; i >= 0; i--) {
            ...
            if (prim.kind !== 'remote' && prim.device)
                return prim.device.kind;
        }
        return null;
    }
    ...
    describe() {
        return Describe.describeProgram(this, this.program);
    }

    _getName() {
        return Describe.getProgramName(this, this.program);
    }
