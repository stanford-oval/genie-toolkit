...
module.exports = class Almond extends events.EventEmitter {
    ...
    notify(data) {
        return this._dispatcher.notify(...data);
    }

    notifyError(data) {
        return this._dispatcher.notifyError(...data);
    }

    askForPermission(data) {
        return this._dispatcher.askForPermission(...data);
    }

    askQuestion(data) {
        return this._dispatcher.askQuestion(...data);
    }

    interactiveConfigure(data) {
        return this._dispatcher.interactiveConfigure(...data);
    }
    ...
    handleThingTalk(thingtalk) {
        ...
        return Intent.parseProgram(thingtalk, this.schemas).then((intent) => {
