...
module.exports = class ProxyManager {
    ...
    sendSinkEvent(targetTier, targetChannelId, data) {
    ...
    requestProxyChannel(proxyChannel, cachedArgs) {
        ...
        var request = {
            ...
            kind: kind,
            mode: mode,
            params: mode === 'r' ? Protocol.params.marshal(params) : undefined,
            proxy: proxyChannel,
    ...
    _requestChannel(fromTier, targetChannelId, device, kind, mode, params) {
        ...
        try {
            ...
            params = mode === 'r' ? Protocol.params.unmarshal(this._messaging, params) : undefined;
        } catch(e) {
            this._replyChannel(fromTier, targetChannelId, e.message);
            return;
        }
    ...
    _channelSinkData(fromTier, targetChannelId, data) {
        var fullId = targetChannelId + '-' + fromTier;
