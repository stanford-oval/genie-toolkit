...
class ProxyChannel extends Tp.BaseChannel {
    constructor(proxyManager, targetTier, targetChannelId, localChannel, cachedArgs) {
        super();
...
module.exports = class ProxyManager {
    ...
    _requestChannel(fromTier, targetChannelId, device, kind, mode, params) {
        ...
        var channel = this._channels.getChannel(device, kind, mode, params);
