...
module.exports = class PairedEngineManager {
    ...
    _addToDB(builtin) {
        ...
        return this._devices.loadOneDevice({ kind: 'org.thingpedia.builtin.' + builtin }, false);
    }
    ...
    start() {
        ...
        // always sync cloud settings at startup (to recognize any change in
        // the developer key)
        ...
        return Q.try(function() {
            return this._addToDB('thingengine.builtin');
        }.bind(this)).then(function() {
