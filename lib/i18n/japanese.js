...
module.exports = class JapaneseLanguagePack extends DefaultLanguagePack {
    isGoodWord(word) {
        ...
        // + allow English names
        return /^([\u30A0-\u30FF\u3041-\u3096\u3400-\u4DB5\u4E00-\u9FCB\uF900-\uFA6Aあいうえおoかきくけこがぎぐげごさしすせそざじずぜぞたちつてとだぢづでどなにぬねのはひふへほばびぶべぼぱぴぷぺぽまみむめもやゆよらりるれろわをんn/\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uffef0-9\u4e00-\u9fafa-zA-Z0-9][\u30A0-\u30FF\u3041-\u3096\u3400-\u4DB5\u4E00-\u9FCB\uF900-\uFA6Aあいうえおoかきくけこがぎぐげごさしすせそざじずぜぞたちつてとだぢづでどなにぬねのはひふへほばびぶべぼぱぴぷぺぽまみむめもやゆよらりるれろわをんn/\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uffef\u4e00-\u9faf\u4e00-\u9fafa-zA-Z0-9.,。，一-]*)$/.test(word);
    }
