...
class SentenceEvaluator {
    constructor(parser, schemaRetriever, tokenized, debug, complexityMetric, ex) {
        this._parser = parser;
    ...
    async evaluate() {
        ...
        if (this._predictions) {
            ...
            try {
                const parsed = await this._parser.sendUtterance(this._preprocessed, contextCode, contextEntities, { tokenized: this._tokenized });
                if (!entities)
...
class SentenceEvaluatorStream extends Stream.Transform {
    constructor(parser, schemas, tokenized, debug, complexityMetric) {
    ...
    _transform(ex, encoding, callback) {
        const evaluator = new SentenceEvaluator(this._parser, this._schemas, this._tokenized, this._debug, this._complexityMetric, ex);
