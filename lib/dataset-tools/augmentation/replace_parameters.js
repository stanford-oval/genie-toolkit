...
const { sampleString } = require('../../utils/misc-utils');


function isReplaceToken(tok) {
    return /^(?:GENERIC_ENTITY_|LOCATION_|PHONE_NUMBER_|NUMBER_|QUOTED_STRING_|HASHTAG_|USERNAME_|DATE_|DURATION_)/.test(tok);
}
