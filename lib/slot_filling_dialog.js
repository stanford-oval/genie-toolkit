...
module.exports = class SlotFillingDialog extends Dialog {
    constructor(slots, prefilled, fillAll, mustFill, scope, icon) {
        ...
        this.resolved_scope = Codegen.assignSlots(slots, prefilled, this.values, this.comparisons, fillAll, mustFill, scope, this.toFill);
        ...
        if (parent.subdialog === null) {
            ...
            return Q(parent.subdialog.continue()).then((waiting) => {
                if (waiting) {
                    ...
                    obj.resolved_scope = parent.subdialog.resolved_scope;
                    parent.pop();
                    return false;
                }
            });
