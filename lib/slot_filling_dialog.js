...
module.exports = class SlotFillingDialog extends Dialog {
    constructor(slots, prefilled, fillAll, mustFill, scope, icon, options, remoteSlots) {
        super();
        ...
        ThingTalk.Generate.assignSlots(slots, prefilled, this.values, this.comparisons, fillAll, mustFill, scope, this.toFill, this.remoteSlots);
    ...
    static slotFill(parent, obj, fillAll, mustFill, scope, options, remoteSlots) {
        ...
        if (parent.subdialog === null) {
            ...
            parent.push(new SlotFillingDialog(slots, obj.args, fillAll, mustFill, scope, icon, options, remoteSlots));
            ...
            if (this._paring === false && this.options !== null && idx < this.options.length) {
                ...
                if (option.length > 0) {
                    ...
                    if (param.type.isString)
                        this.replyChoice(i+1, "arg", this._("A description of the result"));
                    ...
                    if (this.expecting !== null) {
                        ...
                        if (this._paring === true) {
                            ...
                            if (index !== Math.floor(index) ||
                                index < 0 ||
                                index > this.options[this.idx].length+1 ||
                                (index > this.options[this.idx].length  && !this.slots[this._resolving].type.isString)) {
                                this.reply(this._("Please click on one of the provided choices."));
                                this._paring = false;
                                return this.continue();
                            } else if (index === this.options[this.idx].length) {
                                return this.continue();
                            } else if (index === this.options[this.idx].length+1) {
                                this.values[this._resolving] = Ast.Value.VarRef('$event');
                                this.idx = null;
                                this._paring = false;
                                return this.continue();
                            } else {
