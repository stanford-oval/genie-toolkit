...
module.exports = class ParameterReplacer {
    constructor(schemas, constProvider, { locale, quotedProbability, maxSpanLength, untypedStringProbability, rng = Math.random, addFlag = false }) {
        ...
        this._untypedStringProbability = untypedStringProbability;
        this._maxSpanLength = maxSpanLength;
