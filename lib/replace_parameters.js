...
const { makeDummyEntity, sampleString } = require('./utils');
...
module.exports = class ParameterReplacer {
    ...
    async _sampleParam(slot, replacedValuesSet) {
        ...
        while (attempts > 0) {
            ...
            if (!this._paramLangPack.isGoodSentence(sampled) || !pass_test) {
                attempts -= 1;
                continue;
            }
        ...
        console.log(`Could not replace even after ${this._numAttempts} attempts for slot ${slot}`);
