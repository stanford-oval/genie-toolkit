...
module.exports = class DefaultDialog extends Dialog {
    ...
    askForPermission(principal, invocation) {
        var defer = Q.defer();
        var dialog = new PermissionGrantDialog(principal, JSON.stringify(invocation), defer);
    ...
    askQuestion(type, question) {
        var defer = Q.defer();
        var dialog = new AskAnythingDialog(type, question, defer);
