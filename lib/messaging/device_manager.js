...
module.exports = class MessagingDeviceManager extends Tp.Messaging {
    ...
    start() {
        ...
        this._view.on('device-added', this._deviceAddedListener);
        this._view.on('device-removed', this._deviceRemovedListener);
        this._view.start();
    ...
    stop() {
        this._view.removeListener('device-added', this._deviceAddedListener);
        this._view.removeListener('device-removed', this._deviceRemovedListener);
