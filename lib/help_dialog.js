...
module.exports = class HelpDialog extends Dialog {
    ...
    start() {
        this.categories = ['media', 'social-network', 'home', 'communication', 'health', 'service', 'data-management', 'rule'];
        this.titles = [this._('Media'), this._('Social Networks'), this._('Home'), this._('Communication'),
            this._('Health and Fitness'), this._('Services'), this._('Data Management'), this._('Rules')];
    }
    ...
    _getRules() {
        this.reply(this._("Here are some interesting examples of rules: "));
        var description = "if someone commits to github and the message contains bugfix then flash the lights";
        var json = "\{\"rule\":\{\"trigger\":\{\"name\":\{\"id\":\"tt:github.new_commit\"\},\"args\":\[\{\"type\":\"String\",\"operator\":\"contains\",\"value\":\{\"value\":\"bugfix\"\},\"name\":\{\"id\":\"tt:param.message\"\}\}\]\},\"action\":\{\"name\":\{\"id\":\"tt:light-bulb.alert_long\"\},\"args\":\[]\}\}\}"
        this.replyButton(description, json);
        return this.switchToDefault();
    }
