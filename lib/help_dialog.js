...
module.exports = class HelpDialog extends Dialog {
    ...
    start() {
        this.categories = ['apps', 'media', 'social-network', 'home', 'communication', 'health', 'service', 'data-management'];
        this.titles = [this._("Apps"), this._('Media'), this._('Social Networks'), this._('Home'), this._('Communication'),
