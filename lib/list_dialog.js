...
module.exports = class ListDialog extends Dialog {
    ...
    start() {
        this.options = [this.C_('list option', "devices"), this.C_('list option', "commands"), this.C_('list option', "queries")];
    }
    ...
    getQueries() {
        ...
        this.reply(this._("Here're some examples of what I can do for you."));
    ...
    _listContent() {
        ...
        switch (this.listing) {
            ...
            case 'command':
            case 'commands':
                this.reply(this._("Alright, here's a list of commands you can try:"));
                this.reply(this._("‘list devices/queries/commands’: get the devices you have, example queries, or available commands."));
                this.reply(this._("‘discover ____’: search for devices match the name or type you give me."));
                this.reply(this._("‘help ____’: give you some example queries you can do with the device."));
