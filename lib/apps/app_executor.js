...
class AppExecutor extends events.EventEmitter {
    ...
    constructor(engine, code, meta, name, description) {
        ...
        /**
         * The ID of the conversation to use for this app.
         *
         * If null, the app will notify on all conversations at once.
         * @type {string|null}
         * @readonly
         */
        this.conversation = meta.conversation || meta.$conversation || null;
    ...
    /**
     * The output queue to use for the commands that app executes at startup.
     *
     * This is the output queue for synchronous interaction with the user.
     * @type {OutputQueue}
     * @readonly
     */
    get mainOutput() {
    ...
    /**
     * The output queue to use for the commands that app executes in the backgroun.
     *
     * This is the output queue for asynchronous interaction with the user.
     * @type {OutputQueue}
     * @readonly
     */
