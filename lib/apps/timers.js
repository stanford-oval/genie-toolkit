...
class Timer extends BaseTimer {
    ...
    _nextTimeout(_now=null) {
        ...
        let frequency = this._frequency === null ? 1 : this.frequency;
        let nextTiming = null;
        const DAY = 86400000;
        const WEEK = 7 * DAY;
        ...
        else if ((this._interval / frequency) < 3000) {
            throw new Error(`Timer with total interval ${this._interval} and frequency ${this._frequency} will have intervals of ${this._interval / this._frequency}. Minimum interval is 3 seconds.`);
        }
