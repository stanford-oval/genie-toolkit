...
module.exports = class ExecWrapper extends ExecEnvironment {
    ...
    invokeLogQuery(params, aggregation) {
        switch (aggregation) {
            case 'max':
                return this.engine.ibase.getMax(...params);
            case 'min':
                return  this.engine.ibase.getMin(...params);
            case 'argmax':
                return  this.engine.ibase.getArgmax(...params);
            case 'argmin':
                return this.engine.ibase.getArgmin(...params);
            case 'sum':
                return this.engine.ibase.getSum(...params);
            case 'avg':
                return this.engine.ibase.getAvg(...params);
            case 'count':
                return this.engine.ibase.getCount(...params);
            case null:
                return this.engine.ibase.query(...params);
            default:
