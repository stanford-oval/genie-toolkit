...
module.exports = class ExecWrapper extends ExecEnvironment {
    ...
    _genTableName(channel, input) {
        ...
        return channel.device.globalName + '_' + channel.name;
    }
            ...
            return Q.all(channels.map((c) => safeInvoke(c.invokeQuery(params)))).then((results) => {
                ...
                results.forEach((result, i) => {
                    ...
                    for (let element of result) {
                        ...
                        this._save(channel, params, element).then((lastId) => {
                            //TODO: store lastId in cache as current version number
                        });
                    }
                });
    ...
    invokeLogQuery(params, aggregation) {
        return this.engine.memory.get(...params, aggregation);
    }
