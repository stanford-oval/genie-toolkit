...
function* addFilter(dlg, rule) {
    ...
    while (true) {
        ...
        */
        ...
        yield ThingTalk.Generate.typeCheckFilter(predicate, prim.schema, null, dlg.manager.schemas, {}, true);
        for (let [schema,expr,] of ThingTalk.Generate.iterateSlotsFilter(prim.schema, predicate, null, null)) {
