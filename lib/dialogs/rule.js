...
module.exports = function* ruleDialog(dlg, intent, skipConfirmation, uniqueId, sourceIdentity) {
    let source = sourceIdentity ? yield getIdentityName(dlg, sourceIdentity) : null;
    ...
    const code = Ast.prettyprint(program);
    const app = yield dlg.manager.apps.loadOneApp(code, appMeta, uniqueId, undefined,
