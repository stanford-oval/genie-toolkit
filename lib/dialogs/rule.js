...
function* contactSearch(dlg, type, param) {
    console.error('FINISHME: contact search');
    return null;
}
function* resolveLocation(dlg, type, param) {
    console.error('FINISHME: resolve location');
    return null;
}

module.exports = function* ruleDialog(dlg) {
    let program;
