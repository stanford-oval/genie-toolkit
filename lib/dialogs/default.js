...
async function handleUserInput(dlg, intent) {
    if (intent.isFailed || intent.isFallback || intent.isTrain) {
        ...
        await ruleDialog(dlg, intent, false);
        ...
        try {
            ...
            try {
                ...
                if (next.isUserInput) {
                    lastApp = undefined;
                    try {
                        value = await handleUserInput(dlg, next.intent);
                    } catch(e) {
