    ...
    for (;;) {
        try {
            ...
            try {
                ...
                if (next.isUserInput) {
                    ...
                    try {
                        ...
                        if (e.code !== 'ECANCELLED') {
                            await dlg.reply(dlg._("Sorry, I had an error processing your command: %s").format(formatError(e)));
                            console.error(e);
                        }
                    }
                ...
                await dlg.reply(dlg._("Sorry, that did not work: %s").format(formatError(e)));
                console.error(e);
            }
        } catch(e) {
            if (e.code === 'ECANCELLED')
