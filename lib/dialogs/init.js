...
module.exports = async function initDialog(dlg, showWelcome, forceConfigureMatrix) {
    ...
    if (dlg.manager.isAnonymous) {
        if (showWelcome) {
            ...
            dlg.reply(dlg._("I am part of a research project of Stanford University. I am capable of understanding actions and events over web services."));

            dlg.reply(dlg._("Please keep in mind: I do not chat, and I do not understand questions very well. Please check out the Thingpedia to find out what I understand, or type ‘help’."));
        ...
        if (dlg.manager.platform.type === 'cloud') {
            ...
            dlg.reply(dlg._("I am part of a research project of Stanford University. Would you like to participate?"));
            ...
            dlg.reply(dlg._("You must be 13 or older to participate. If you are not, please answer ‘No’ here. Your answer will not affect the functionality of Almond."));
            ...
            dlg.reply(dlg._("Ok, on to what I can do: I am capable of understanding actions and events over web services and smart devices. I do not chat, and I do not understand questions very well. Please check out the Cheatsheet (from the menu) to find out what I understand, or type ‘help’."));
        }

        //dlg.reply(dlg._("You can also configure your personal accounts. To do so, try ‘configure‘ followed by the type of account (e.g., ‘configure twitter’ or ‘configure nest’)."));
