...
module.exports = async function initDialog(dlg, showWelcome, forceConfigureMatrix) {
    ...
    if (dlg.manager.isAnonymous) {
        ...
        if (dlg.manager.platform.type === 'cloud') {
            ...
            await dlg.reply(dlg._("The collection is completely anonymous, and I will strip personal data (such as search queries, messages or phone numbers). The data, once collected, will be shared only with our developers and researchers."));
            await dlg.reply(dlg._("You must be 18 or older to participate. If you are not, please answer ‘No’ here. Your answer will not affect the functionality of Almond."));
            ...
            await dlg.reply(dlg._("If you would like to know more, see our privacy policy at https://almond.stanford.edu/about/privacy or contact us at <thingpedia-admins@lists.stanford.edu>."));
