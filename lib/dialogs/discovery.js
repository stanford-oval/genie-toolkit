...
function completeDiscovery(dlg, device) {
    const delegate = {
        ...
        requestCode(question) {
            return dlg.ask(ValueCategory.RawString, question);
        }
    }
...
module.exports = function* discoveryDialog(dlg, intent) {
    ...
    let discoveryName, discoveryType, discoveryKind;
    let devices;
    ...
    try {
        ...
        dlg.manager.stopDiscovery().catch((e) => {
