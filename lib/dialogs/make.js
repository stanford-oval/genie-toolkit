        ...
        while(true) {
            ...
            if (ready) {
                ...
                if (primType === 'trigger' && !utterances[index].endsWith('notify me'))
                    ...
                    format = "%s";
                choices.push(format.format(utterances[index] + filterDescription[index]));
                choices.push(dlg._("Add a filter"));
                choices.push(dlg._("Run it"));
                hint = dlg._("Add more filters or run your command if you are ready.");
            } else {
                choices.push(dlg._("Pick a device to start"));
                hint = dlg._("Click the following button to pick a device.");
            }
