...
module.exports = class Engine {
    constructor(platform) {
        ...
        if (hasMessaging) {
            var PermissionManager = require('./permission/permission_manager');
            var RemoteExecutor = require('./permission/remote_executor');
            var PermissionControlResponder = require('./messaging/permission_control_responder');

            var permissionManager = new PermissionManager();
            var executor = new RemoteExecutor(permissionManager);
            this._modules.push(new PermissionControlResponder(executor, this._messaging));
        }
