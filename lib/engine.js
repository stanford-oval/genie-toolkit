...
module.exports = class Engine {
    constructor(platform, options = {}) {
        ...
        if (hasPermissions) {
            ...
            let permissionManager = new PermissionManager(this._platform, this._messaging, this._schemas);
            this._modules.push(permissionManager);
            this._remote = new PermissionControlResponder(permissionManager, this._messaging, this._tiers, this._devices, this._schemas);
