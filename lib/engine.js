 ...
 * The Thingpedia SDK.
 * @external thingpedia
 * @see https://almond.stanford.edu/doc/jsdoc/thingpedia-api/
 */
 ...
 * can run in the same process, and they are usually associated with
...
class Engine extends Tp.BaseEngine {
     ...
     * @type {external:thingpediadiscovery.DiscoveryClient}
     * @readonly
     */
    get discovery() {
