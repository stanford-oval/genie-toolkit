...
const GraphDatabase = require('datashare');
...
module.exports = class Engine {
    constructor(platform) {
        ...
        this._devices = new DeviceDatabase(platform, this._tiers,
                                           new ThingPediaClient.DeviceFactory(this, thingpedia),
        ...
        this._apps = new AppDatabase(this);
        ...
        this._modules = [this._tiers,
                         ...
                         this._apps,
                         this._ui,
                         new GraphDatabase(platform, this._messaging),
...
module.exports.prototype.$rpcMethods = ['get channels', 'get devices', 'get apps', 'get ui', 'get assistant',
                                        'get messaging'];
