...
const MessagingQueryResponder = require('./messaging/query_responder');
const KeywordRegistry = require('./keyword/registry');
const SparqlRunner = require('./graphdb/sparql_runner');
const GraphMetaStore = require('./graphdb/metastore');
...
module.exports = class Engine {
    constructor(platform) {
        ...
        this._modules = [this._tiers,
                         ...
                         this._apprunner,
                         new MessagingQueryResponder(this._graphdb, this._messaging),
